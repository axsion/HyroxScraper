...
// Récupère le chemin exact de Chrome
...
// Fonction pour scraper un événement unique
...
// Route principale : scraper toute la saison
app.get("/api/scrape-season", async (req, res) => {
  ...
  try {
    ...
    // Récupère les liens des événements terminés
    ...
    // Scraper les 5 premiers événements pour test
